...
W3: the pitch page and stand deck carry one pricing line quoting the file and its version;
nothing else changes. Slide 10 loses the size bands and any number of places.
