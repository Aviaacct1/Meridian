...
W6: prices stay unpublished until November and the group bands are never published; the seven
files carrying the size grid are rewritten to the file before the November publication, not
before Routes. Messaging sentence 3 (the offer) drops any number of places.
