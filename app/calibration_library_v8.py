...
LAST UPDATED: February 2026 (Chat 49 -- added BR TPE-SJC Aug2019 cases 21-22, rules 23-26, updated JX provenance)
"""
...
CALIBRATION_CASES = [
    ...
    # =========================================================================
    {
        ...
        "notes": [
            ...
            "PROVENANCE (Chat 48): P2P identical to Case 22 (BR TPE-SJC Aug19-B). Created by stripping connecting from EVA hub forecast.",
        ],
    },
    ...
    # =========================================================================
    # CASE 21: BR TPE-SJC Aug19-A (EVA Air, 4x Weekly, B777-300ER, 323 seats)
    # Working draft scenario -- NOT the finalised version
    # =========================================================================
    {
        "route_id": "BR_TPE_SJC_4x_Aug19A",
        "origin": "TPE",
        "destination": "SJC",
        "origin_city": "TPE",
        "destination_city": "SJC",
        ...
        "frequency": 4,
        "aircraft": "B777-300ER",
        "seats_per_flight": 323,
        "seat_config": "42J/225Y",
        "annual_seats": 134368,
        "departure_time_home": "23:55",
        "departure_time_dest": None,
        "forecast_year": 2022,
        "data_vintage": "2018 Sabre",
        "existing_service": False,
        "existing_nearby": True,  # BR TPE-SFO exists

        # P2P DEMAND -- asymmetric capture approach
        "p2p_base_demand": 142499,
        "p2p_segments": {
            "Taiwan Business":          {'base': 45600, 'growth': 0.09, 'stim': 1.15, 'capture': 0.42},
            "Taiwan Leisure Primary":   {'base': 7096,  'growth': 0.09, 'stim': 1.00, 'capture': 0.25},
            "Taiwan Leisure Secondary": {'base': 3403,  'growth': 0.09, 'stim': 1.00, 'capture': 0.25},
            "Taiwan Leisure Contested": {'base': 901,   'growth': 0.09, 'stim': 1.00, 'capture': 0.07},
            "US Business":              {'base': 68400, 'growth': 0.09, 'stim': 1.15, 'capture': 0.23},
            "US Leisure Primary":       {'base': 10644, 'growth': 0.08, 'stim': 1.00, 'capture': 0.35},
            "US Leisure Secondary":     {'base': 5105,  'growth': 0.08, 'stim': 1.00, 'capture': 0.35},
            "US Leisure Contested":     {'base': 1351,  'growth': 0.08, 'stim': 1.00, 'capture': 0.15},
        },
        "p2p_stimulation": 1.15,  # business; leisure uses 1.00
        "p2p_capture_rate": "Asymmetric: TW Bus 42%, US Bus 23%",
        "p2p_capture_rate_range": "7-42%",
        "p2p_forecast": 52829,
        "p2p_business_split": 0.83,

        # CONNECTING
        "cnx_home_pool": 1505239,
        "cnx_home_qsi_share_blended": 0.02188,
        "cnx_home_forecast": 32932,
        "cnx_dest_pool": 1192162,
        "cnx_dest_qsi_share_blended": 0.00312,
        "cnx_dest_forecast": 3715,

        # TOTALS
        "grand_total_forecast": 89475,
        "load_factor": 0.666,
        "qsi_adjustment": 1.0,
        "factor_up": 1.0,
        ...
        "calibration_factors_by_market": {
            "description": "QSI adj 1.0 -- new route, raw model accepted",
        },

        "schedule_sensitivity": {
            "departure_time": "23:55 TPE -- very late night",
            "impact": "Connecting share 37% -- between evening (33% at 20:00) and midday (19%). "
                     "Late-night catches some overnight feed but misses peak evening wave.",
        },

        "notes": [
            "WORKING DRAFT -- superseded by Finalised scenario (Case 22)",
            "Most extreme capture asymmetry in library: TW bus 42% vs US bus 23%",
            "Zero stimulation on all leisure segments (1.00) -- unusual",
            "23:55 departure -- latest in library. LF only 66.6% -- weak schedule",
            "9% compound growth for both segments (4-year horizon to 2022)",
            "Abandoned in favour of Finalised version with standardised parameters",
            "Valuable for calibration: shows analyst's rejected approach",
        ],
    },

    # =========================================================================
    # CASE 22: BR TPE-SJC Aug19-B Finalised (EVA Air, 5x Weekly, A350, 304 seats)
    # Final calibrated version -- also source for JX TPE-SJC (Case 13)
    # =========================================================================
    {
        "route_id": "BR_TPE_SJC_5x_Aug19B",
        "origin": "TPE",
        "destination": "SJC",
        "origin_city": "TPE",
        "destination_city": "SJC",
        ...
        # P2P DEMAND -- standardised approach
        "p2p_base_demand": 142500,
        "p2p_segments": {
            "Taiwan Business":          {'base': 45600, 'growth': 0.125, 'stim': 1.10, 'capture': 0.40},
            "Taiwan Leisure Primary":   {'base': 9333,  'growth': 0.097, 'stim': 1.10, 'capture': 0.40},
            "Taiwan Leisure Secondary": {'base': 1287,  'growth': 0.097, 'stim': 1.05, 'capture': 0.40},
            "Taiwan Leisure Contested": {'base': 780,   'growth': 0.097, 'stim': 1.05, 'capture': 0.25},
            "US Business":              {'base': 68400, 'growth': 0.125, 'stim': 1.10, 'capture': 0.40},
            "US Leisure Primary":       {'base': 14000, 'growth': 0.097, 'stim': 1.10, 'capture': 0.40},
            "US Leisure Secondary":     {'base': 1930,  'growth': 0.097, 'stim': 1.05, 'capture': 0.40},
            "US Leisure Contested":     {'base': 1170,  'growth': 0.097, 'stim': 1.05, 'capture': 0.25},
        },
        "p2p_stimulation": 1.10,
        "p2p_capture_rate": 0.40,
        "p2p_capture_rate_range": "25-40%",
        "p2p_forecast": 69736,
        "p2p_business_split": 0.81,

        # CONNECTING
        "cnx_home_pool": 1511928,
        "cnx_home_qsi_share_blended": 0.02188,
        "cnx_home_forecast": 33078,
        "cnx_dest_pool": 1219257,
        "cnx_dest_qsi_share_blended": 0.00312,
        "cnx_dest_forecast": 3800,

        # TOTALS
        "grand_total_forecast": 106613,
        "load_factor": 0.674,
        "qsi_adjustment": 1.0,
        "factor_up": 1.0,
        ...
        "growth_assumptions": {
            "business_compound": 0.125,  # 12.5% compound over ~4 years
            "leisure_compound": 0.097,   # 9.7% compound
            "rationale": "Bay Area-Taiwan semiconductor corridor + tech bilateral trade",
        },

        "provenance": {
            "source_sheet": "Forecast Finalised",
            "relationship_to_case_13": "JX TPE-SJC (Case 13) P2P forecast of 69,736 is IDENTICAL "
                                       "to this case's P2P component. Case 13 was created by "
                                       "stripping connecting traffic from this hub carrier forecast.",
            "repurposing_method": "P2P component is carrier-neutral. Connecting component "
                                  "(33,078 via TPE hub) is EVA-specific and was removed for Starlux.",
        },

        "notes": [
            "FINALISED VERSION -- final analyst-calibrated output",
            "Standardised parameters: 1.10 stim business/primary, 1.05 secondary/contested",
            "Uniform 40% capture for business/primary/secondary, 25% contested",
            "P2P component (69,736) = Case 13 (JX TPE-SJC) exactly -- confirmed provenance",
            "12.5% business growth and 9.7% leisure growth -- revised from 9% in Scenario A",
            "23:55 departure -- same weak schedule as Scenario A",
            "67.4% LF still weak but better than 66.6% (more frequency but smaller aircraft)",
            "Independent forecast test: engine predicted parameters EXACTLY (0.0% error)",
            "This is the strongest validation that 2019 TPE-SJC defaults are correct",
        ],
    },

    # =========================================================================
    # CASE 23: AV BOG-AUS (Avianca Bogota - Austin)
    # =========================================================================
    {
        "route_id": "AV_BOG_AUS",
        "origin": "BOG",
        ...
        "route_type": "Hub Longhaul",
        "hub_airport": "BOG",
        "hub_status": "Major Hub",  # El Dorado: Latin America's busiest airport
        "frequency": 5,  # 5x weekly
        "aircraft": "A319",
        "seats_per_flight": 120,
        "annual_seats": 62400,  # 120 * 5 * 52 * 2
        "departure_time_home": None,
        "departure_time_dest": None,
        "forecast_year": 2026,
        "data_vintage": "Sabre MI Jan-Dec 2022",
        "existing_service": False,  # new route, no existing direct

        # DEMAND
        "p2p_base_demand": 12200,
        "p2p_growth_rate": 0.21,  # 21% compound -- Latin America post-COVID recovery
        "p2p_growth_years": 2,    # 2022 -> 2024
        "p2p_after_growth": 14400,
        "p2p_stimulation": 2.25,  # high stim for very small indirect pool
        "p2p_after_stimulation": 34600,
        "p2p_capture_rate": 0.80,  # monopoly new route, no competing direct
        "p2p_forecast": 27700,
        "p2p_business_split": 0.30,  # predominantly leisure/VFR
        "p2p_visitor_resident_split": None,

        # CONNECTING
        "cnx_home_base": 66700,  # total connecting demand at BOG hub
        "cnx_home_growth": 0.21,
        "cnx_home_capture": 0.118,  # 11.8% blended connecting capture
        "cnx_home_forecast": 7900,
        "cnx_dest_base": 0,
        "cnx_dest_forecast": 0,

        # TOTALS
        "total_forecast": 35600,
        "load_factor": 0.571,  # 35,600 / 62,400 = 57.1%
        "actual_load_factor": 0.571,

        # QSI
        "qsi_adjustment": 1.0,  # new route, no adjustment needed
        "qsi_ceiling": 1.0,

        # MARKET CONTEXT
        "market_maturity": "new_monopoly",
        "competitive_intensity": "low",  # no competing direct service
        "direct_competition_exists": False,
        "hub_connecting_competition": "moderate",  # US carriers offer BOG connects via MIA/IAH

        "notes": [
            "Avianca new route proposal to Austin-Bergstrom",
            "Very high P2P capture (80%) reflects monopoly position -- no direct service exists",
            "High stimulation (2.25x) for small indirect pool -- IATA curve driven",
            "Latin America post-COVID growth rates significantly above mature markets",
            "Low load factor (57%) acceptable for Year 1 new route ramp-up",
            "Connecting at BOG hub relatively modest (22% of total)",
            "Colombian diaspora in Texas (134k) supports VFR demand",
        ],
    },

    # =========================================================================
    # CASE 24: AV BOG-CLT (Avianca Bogota - Charlotte)
    # =========================================================================
    {
        "route_id": "AV_BOG_CLT",
        "origin": "BOG",
        ...
        # DEMAND
        "p2p_base_demand": 13241,
        "p2p_growth_rate": 0.21,
        "p2p_growth_years": 2,
        "p2p_after_growth": 16015,
        "p2p_stimulation": 2.25,
        "p2p_after_stimulation": 36034,
        "p2p_capture_rate": 0.80,
        "p2p_forecast": 28827,
        "p2p_business_split": 0.35,

        # CONNECTING
        "cnx_home_base": 60199,
        "cnx_home_growth": 0.21,
        "cnx_home_capture": 0.151,  # 15.1% blended
        "cnx_home_direct_comp_capture": 0.0,  # no O&Ds with direct competition
        "cnx_home_no_direct_capture": 0.151,
        "cnx_home_forecast": 10993,
        "cnx_dest_base": 0,
        "cnx_dest_forecast": 0,

        # TOTALS
        "total_forecast": 39820,
        "load_factor": 0.638,
        "actual_load_factor": 0.638,
        ...
        "direct_competition_exists": False,
        "hub_connecting_competition": "moderate",

        "notes": [
            "Avianca new route proposal to Charlotte Douglas",
            "CLT has 70% connecting share -- highest in US -- AA secondary hub",
            "Colombian diaspora in Carolinas (~50k) supports VFR",
            "72% P2P share reflects strong local O&D demand",
            "Higher connecting capture (15.1%) than BOG-AUS (11.8%) due to BOG hub strength",
        ],
    },

    # =========================================================================
    # CASE 25: KL AMS-DEN (KLM Amsterdam - Denver)
    # =========================================================================
    {
        "route_id": "KL_AMS_DEN",
        "origin": "AMS",
        ...
        "route_type": "Hub Longhaul",
        "hub_airport": "AMS",
        "hub_status": "Major Hub",  # AMS is KLM's primary hub
        "frequency": 5,
        "aircraft": "B777-200ER",
        "seats_per_flight": 320,
        "annual_seats": 166400,
        "departure_time_home": None,
        "departure_time_dest": None,
        "forecast_year": 2025,
        "data_vintage": "Sabre MI Jan-Dec 2019",
        "existing_service": False,

        # DEMAND
        "p2p_base_demand": 51700,
        "p2p_growth_rate": 0.032,  # ~3.2% CAGR -- mature transatlantic
        "p2p_growth_years": 6,     # 2019 -> 2025
        "p2p_after_growth": 62400,
        "p2p_stimulation": 1.40,
        "p2p_after_stimulation": 87300,
        "p2p_capture_rate": 0.60,
        "p2p_forecast": 52400,
        "p2p_business_split": 0.40,

        # CONNECTING -- key pattern: direct comp vs no-direct split
        "cnx_home_base": 1117500,
        "cnx_home_growth": 0.032,
        "cnx_home_capture": 0.055,  # 5.5% blended
        "cnx_home_direct_comp_base": 508200,
        "cnx_home_direct_comp_capture": 0.014,  # 1.4% when direct exists
        "cnx_home_no_direct_base": 609300,
        "cnx_home_no_direct_capture": 0.089,    # 8.9% when no direct
        "cnx_home_forecast": 74500,
        "cnx_dest_base": 0,
        "cnx_dest_forecast": 0,

        # TOTALS
        "total_forecast": 126900,
        "load_factor": 0.763,
        "actual_load_factor": 0.763,

        # QSI
        "qsi_adjustment": None,  # analyst-set, not QSI-driven
        "qsi_ceiling": None,

        "market_maturity": "new_hub_route",
        "competitive_intensity": "high",  # UA EWR, DL ATL, AA CLT/PHL all offer AMS-DEN connects
        "direct_competition_exists": False,  # no existing direct AMS-DEN
        "hub_connecting_competition": "very_high",  # 45% of connecting demand has direct service

        "notes": [
            "KLM new route proposal to Denver -- large hub route with massive connecting pool",
            "Mature transatlantic growth rate (3.2%) vs Latin America (21%)",
            "Critical pattern: 45% of connecting demand has DIRECT competition -> 1.4% capture",
            "No-direct connecting cities get 8.9% capture -- 6x higher than direct-comp cities",
            "Direct service penalty of ~85% (1.4/8.9) validated against analyst methodology",
            "DEN is large airport (58.8M pax) with strong UA hub presence",
            "76.3% LF appropriate for new European long-haul competing with established US carriers",
        ],
    },

    # =========================================================================
    # CASE 26: KL AMS-MSY (KLM Amsterdam - New Orleans)
    # =========================================================================
    {
        "route_id": "KL_AMS_MSY",
        "origin": "AMS",
        ...
        # DEMAND
        "p2p_base_demand": 18043,
        "p2p_growth_rate": 0.024,  # 2.4% -- small, mature market
        "p2p_growth_years": 1,     # minimal growth applied
        "p2p_after_growth": 18476,
        "p2p_stimulation": 2.20,   # high stim for small indirect pool
        "p2p_after_stimulation": 40648,
        "p2p_capture_rate": 0.50,  # lower capture for small leisure market
        "p2p_forecast": 20324,
        "p2p_business_split": 0.25,  # predominantly leisure/tourism

        # CONNECTING -- critical pattern: small dest airport = high cnx capture
        "cnx_home_base": 359906,
        "cnx_home_growth": 0.028,
        "cnx_home_capture": 0.219,  # 21.9% blended -- much higher than DEN
        "cnx_home_direct_comp_base": 78397,
        "cnx_home_direct_comp_capture": 0.035,  # 3.5% with direct comp
        "cnx_home_no_direct_base": 281509,
        "cnx_home_no_direct_capture": 0.270,    # 27% without direct -- very high
        "cnx_home_forecast": 81111,
        "cnx_dest_base": 0,
        "cnx_dest_forecast": 0,

        # TOTALS
        "total_forecast": 101435,
        "load_factor": 0.610,
        "actual_load_factor": 0.610,
        ...
        "market_maturity": "new_hub_route",
        "competitive_intensity": "moderate",  # less competing hub traffic than DEN
        "direct_competition_exists": False,
        "hub_connecting_competition": "moderate",

        "notes": [
            "KLM new route proposal to New Orleans -- smaller market vs DEN",
            "KEY PATTERN: Small dest airport (MSY) = much higher cnx capture (21.9% vs DEN 5.5%)",
            "No-direct cities capture 27% at MSY vs 8.9% at DEN -- less routing competition",
            "Lower P2P capture (50%) reflects smaller, leisure-heavy market with less corporate demand",
            "2.4% growth rate -- even more conservative than DEN (3.2%)",
            "61% LF acceptable for smaller market with seasonal variation",
            "80% connecting share -- connecting dominates on small O&D to large hub",
            "Direct comp capture still low (3.5%) -- consistent with DEN pattern (1.4%)",
        ],
    },
]
...
CALIBRATION_PATTERNS = {
    ...
    # =========================================================================
    # CALIBRATION RULES FROM BR TPE-SJC Aug2019 INDEPENDENT FORECAST (Chat 49)
    # =========================================================================

    "rule_5_vintage_determines_stimulation": {
        "description": "Analyst calibration evolves over time -- use vintage-appropriate defaults",
        "trigger": "Multiple forecasts exist for the same city pair across different years",
        "finding": "BR TPE-SJC stimulation dropped from 1.20 (2017 vintage) to 1.10 (2019 vintage). "
                  "CI TPE-SJC (2019) also used 1.10. JX TPE-SJC (2019) also used 1.10.",
        "rule": "When library has cases from multiple vintages, use the MOST RECENT vintage "
               "for default parameter selection. Older vintages may reflect outdated market assumptions.",
        "evidence": {
            "2017_cases": {"BR_Sch1-4": 1.20, "explanation": "2017 market had fewer competitors"},
            "2019_cases": {"CI": 1.10, "JX": 1.10, "BR_Aug19B": 1.10, "explanation": "2019 market more competitive"},
        },
        "discovered": "Chat 49 independent forecast test",
    },

    "rule_6_reject_capture_asymmetry": {
        "description": "Large capture asymmetry between origin directions should be flagged and standardised",
        "trigger": "P2P capture differs by >15pp between origin directions (e.g., TW bus 42% vs US bus 23%)",
        "finding": "Scenario A used extreme asymmetry (42% TW vs 23% US business). "
                  "Finalised version REJECTED this, standardising to 40% for both.",
        "rule": "When engine detects >15pp asymmetry, flag for expert review. Default to "
               "the symmetric average (round to nearest 5pp). Analyst will usually standardise.",
        "evidence": "Case 21 (rejected) vs Case 22 (finalised with symmetric 40%)",
        "exception": "Asymmetry may be valid for markets with genuinely different competitive "
                    "structures in each direction (e.g., hub dominance in one direction only)",
        "discovered": "Chat 49 independent forecast test",
    },

    "rule_7_late_night_connecting_share": {
        "description": "Late-night departures (after 22:00) have specific connecting traffic patterns",
        "trigger": "Proposed departure time after 22:00 local at hub airport",
        "finding": "23:55 TPE departure: connecting share 31-37% vs 33% for 20:00 evening "
                  "and 19-20% for midday. Late-night is BETWEEN evening and midday, not worst.",
        "rule": "For late-night hub departures (22:00-02:00), connecting share should be "
               "30-37% of total -- slightly worse than optimal evening but MUCH better than "
               "midday because overnight feed connections are still valid.",
        "evidence": {
            "20:00_TPE": {"cnx_share": 0.33, "case": "BR_Sch1"},
            "23:55_TPE": {"cnx_share": 0.31, "case": "BR_Aug19B_Finalised"},
            "12:00_TPE": {"cnx_share": 0.19, "case": "BR_Sch2"},
            "13:40_TPE": {"cnx_share": 0.20, "case": "BR_Sch3"},
        },
        "note": "QSI scores don't change with departure time -- they come from connection builder. "
               "What changes is which feed connections are feasible within MCT windows.",
        "discovered": "Chat 49 independent forecast test",
    },

    "rule_8_hub_to_nonhub_repurposing": {
        "description": "Hub carrier forecasts can be repurposed for non-hub carriers using P2P component only",
        "trigger": "Route pitch for carrier without hub connectivity at the hub airport",
        "method": "Use P2P component from hub carrier forecast. Set cnx_home=0 and cnx_dest=0. "
                 "P2P demand is carrier-neutral (depends on market, not on hub network). "
                 "Connecting demand is hub-carrier-specific and must be removed.",
        "evidence": "JX TPE-SJC (Case 13) at 69,736 pax = BR TPE-SJC Aug19-B (Case 22) P2P "
                   "component exactly. Confirmed identical numbers cell-by-cell.",
        "warnings": [
            "LF will be low without connecting -- flag viability risk",
            "Non-hub carrier may need smaller aircraft to achieve acceptable LF",
            "Frequency sensitivity differs: non-hub carrier has no connecting upside from extra frequency",
        ],
        "discovered": "Chat 49 source file extraction",
    },

    "independent_forecast_test_results": {
        "description": "Blind prediction test results from Chats 43, 47, 49",
        ...
        "test_3_br_tpe_sjc_aug19": {
            "scenario_a_draft": {
                "error_pct": 16.6,
                "explanation": "Engine predicted Finalised parameters, draft used idiosyncratic approach",
            },
            "scenario_b_finalised": {
                "error_pct": 0.0,
                "explanation": "PERFECT MATCH -- all 8 P2P segments predicted exactly",
            },
            "connecting_error": {"tpe": 0.6, "sjc": -3.7},
            "rules_discovered": 4,
            "chat": 49,
        },
        "cumulative_record": {
            "tests_run": 5,
            "within_1pct": 4,  # CI, FRA(r2), MUC(r2), BR_Aug19B
            "within_5pct": 4,
            "over_10pct": 1,  # BR_Aug19A (draft, not finalised)
            "note": "The one >10% case was a REJECTED draft, not the analyst's final calibration. "
                   "Engine consistently matches analyst's final answer.",
        },
...
ROUTE_LEARNINGS = {
    ...
    "BR_TPE_SJC_late_night_departure": {
        "lesson": "Late-night departures (22:00+) perform between evening and midday for connecting",
        "detail": "23:55 TPE departure: connecting share 31-37%. Evening 20:00: 33%. Midday 12:00: 19%. "
                  "Late night catches some overnight feed (red-eye arrivals from SE Asia) but misses "
                  "the peak evening wave. QSI scores unchanged -- connection builder evaluates all routings "
                  "regardless of departure time. What changes is the set of feasible connections.",
        "applicable_to": "Any hub carrier route where late-night departure is proposed or required by slot availability",
    },

    "BR_TPE_SJC_calibration_evolution": {
        "lesson": "Same analyst, same city pair -- calibration parameters evolve between vintages",
        "detail": "2017 BR TPE-SJC: stim 1.20, capture 45% business. "
                  "2019 BR TPE-SJC: stim 1.10, capture 40% business. "
                  "2019 CI TPE-SJC: stim 1.10, capture 30% (SkyTeam discount). "
                  "Pattern: analyst reduced stimulation by 0.10 and capture by 5pp between 2017 and 2019. "
                  "Likely reflects CI launching TPE-SJC in interim, adding direct competition.",
        "applicable_to": "Any city pair with historical forecasts -- use most recent vintage for defaults",
    },

    "BR_JX_TPE_SJC_repurposing": {
        "lesson": "Hub carrier forecasts can be repurposed for non-hub carriers by extracting P2P",
        "detail": "JX TPE-SJC (69,736 pax) = BR TPE-SJC Aug19-B P2P component exactly. "
                  "Confirmed identical cell-by-cell. P2P demand is market-driven (not carrier-specific). "
                  "Connecting demand is hub-network-specific (33,078 via TPE for EVA, zero for Starlux). "
                  "Automated system should support this: given a hub carrier forecast, generate a "
                  "non-hub variant by zeroing connecting traffic.",
        "applicable_to": "Route development pitches where non-hub carrier is being proposed on a "
                         "route where hub carrier data already exists",
    },

    "BR_TPE_SJC_draft_vs_final": {
        "lesson": "Analyst draft parameters often differ significantly from final calibration",
        "detail": "Scenario A (draft): asymmetric capture (42% TW / 23% US), zero leisure stim, 9% growth. "
                  "Scenario B (final): symmetric 40% capture, 1.10 stim, 12.5%/9.7% growth. "
                  "The independent forecast engine predicted the final parameters exactly (0.0% error) "
                  "but overshot the draft by 16.6%. This means the engine's defaults match where "
                  "analysts converge after iteration, not their initial exploratory approach.",
        "applicable_to": "Engine design -- the automated system should produce 'final quality' defaults "
                         "rather than trying to replicate the analyst's exploration process",
    },
}
...
PENDING_CASES = [
    # All original pending cases now extracted (Chats 43-49)
    ...
    # JX_TPE_SJC -- EXTRACTED (provenance confirmed Chat 48-49)
    # CI_TPE_SJC -- EXTRACTED (Chat 43)
    # BR_TPE_SJC -- EXTRACTED (Chat 45: 4 schedule variants; Chat 48-49: Aug2019 A+B)
...
if __name__ == "__main__":
    ...
    print()
    print("=== TPE-SJC All Variants ===")
    compare_cases("CI_TPE_SJC_A350", "BR_TPE_SJC_5x_Sch1", "BR_TPE_SJC_5x_Aug19B", "JX_TPE_SJC")
