...
Run: py -3.12 "C:\\Avia\\sabre_generate_demand.py" --catchment SFO,LAX,SAN --year 2013 --combine-directions
"""
...
def main():
    ...
    ap.add_argument("--lookup", default=r"C:\Avia\airport_city_country.csv")
    ap.add_argument("--scope", default=r"C:\Avia\destination_scope_LHR.csv")
    ...
    ap.add_argument("--out", default=r"C:\Avia\demand_extract.csv")
    a=ap.parse_args()
