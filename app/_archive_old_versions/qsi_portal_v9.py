#!/usr/bin/env python3
"""
Avia Solutions -- QSI Route Forecast Portal v9.0
==========================================================
...
v9 changes:
  - Tab 10 expanded: market_research_executor wired in
    * Execution plan generation with block-by-block prompts
    * Findings tracking UI (add findings, citations, data gaps per block)
    * Quality score computation
    * Download outputs: Markdown report, JSON, Excel workbook
...
Avia Solutions -- QSI Route Forecast Portal v9.0<br>
30 modules | 14 tabs | Pre-computed + New Route Assessment paths<br>
Market Research Executor + Predictive Calibration Engine + Q&A Checklist + Spill Analysis<br>
