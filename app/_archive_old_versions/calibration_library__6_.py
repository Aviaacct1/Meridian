...
LAST UPDATED: February 2026 (Chat 45  added BR TPE-SJC 4 schedule variants from source files)
"""
...
PENDING_CASES = [
    # All original pending cases now extracted (Chat 44)
...
if __name__ == "__main__":
    ...
    print()
    compare_cases("EI_DUB_SJC_4x", "EI_DUB_SJC_7x", "AF_CDG_SJC")
