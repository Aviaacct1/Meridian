#!/usr/bin/env python3
"""
Avia Solutions -- QSI Route Forecast Portal v10.0
==========================================================
Streamlit web portal with two data-source paths and 15 tabs:
...
v10 changes:
  - Tab 15 added: fare_allocation module wired in
    * Upload Sabre fare files (home + dest direction)
    * Parse per-market fares and cabin splits
    * Per-market connecting revenue breakdown
    * Fare comparison (simple avg vs pax-weighted)
    * Download fare allocation Excel workbook
...
<div class="portal-header">
    ...
    31 modules &nbsp; | &nbsp; Pre-computed + New Route Assessment &nbsp; | &nbsp; 15 tabs</p>
</div>
""", unsafe_allow_html=True)
...
if st.session_state.data_source == 'newroute':
    ...
    tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9, tab10, tab11, tab12, tab14, tab15 = st.tabs([
        "Data Upload & Run", "Results", "Monthly Profile", "Revenue",
        "Assumptions", "Business Case", "Output Workbook",
        "Q&A Checklist", "Spill Analysis", "Market Research",
...
Avia Solutions -- QSI Route Forecast Portal v10.0<br>
31 modules | 15 tabs | Pre-computed + New Route Assessment paths<br>
Fare Allocation + Market Research Executor + Predictive Calibration Engine<br>
Q&A Checklist + Spill Analysis + Seasonality + Revenue + Assumptions Log<br>
Business Case + Output Workbook + Cross-Route Validation + Departure Time Grid<br>
