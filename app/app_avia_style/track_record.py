...
def render_html(t, source_name, engine_ctx=None):
  ...
  <div class="card">
    ...
    if t.get("stats_corr"):
        ...
        corr_html = f"""
  <div class="card" style="border:2px solid {ACCENT}">
    <span class="badge" style="background:{ACCENT};color:#fff">DEVELOPMENT &middot; in-sample, calibrated on all data</span>
